...
Initially, I suspected a rendering issue common to Electron on Linux/WSL2:
...
I systematically tested several standard fixes, but none worked:
...
## Root Cause Analysis
I examined the component responsible for the recording UI (`ControlDock` in `TranscriptionPane.tsx`) and found a critical CSS size mismatch:
...
## Final Solution
I applied a precise CSS fix to ensure layout stability:
