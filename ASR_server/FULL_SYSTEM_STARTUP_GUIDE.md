...
> **Languages**: [English](FULL_SYSTEM_STARTUP_GUIDE.md) | [简体中文](FULL_SYSTEM_STARTUP_GUIDE.zh-CN.md)
...
Your machine has an **RTX 5060**, it is strongly recommended to enable GPU acceleration for ultimate recognition speed.
